...
@Component({
  selector: 'app-boxes-listar',
  templateUrl: './boxes-listar.component.html',
  styleUrls: ['./boxes-listar.component.scss']
})

export class BoxesListarComponent implements OnInit {
  index: 1;
  categorias: any[] = [];
  pageActual: 1;
